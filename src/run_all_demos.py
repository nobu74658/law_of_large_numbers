...
def main():
    ...
    try:
        ...
        # 3. 中心極限定理（一様分布）
        run_demo("central_limit_theorem.py", "中心極限定理 - 一様分布")
        
        # 4. 中心極限定理（指数分布）
        run_demo("central_limit_theorem_exponential.py", "中心極限定理 - 指数分布")
        
        # 5. 中心極限定理（カイ二乗分布）
        run_demo("central_limit_theorem_chi2.py", "中心極限定理 - カイ二乗分布")
        
        # 6. 中心極限定理（パレート分布）
        run_demo("central_limit_theorem_pareto.py", "中心極限定理 - パレート分布")
        
        # 7. 中心極限定理（分布の比較）
        run_demo("central_limit_theorem_comparison.py", "中心極限定理 - 分布の比較")
